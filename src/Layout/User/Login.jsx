...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://192.168.0.118:5500/api/login', {
        email,
        password,
      });
  ...
  return (
    <section>
      <div style={{ textAlign: 'center', fontSize: '2.2rem', fontWeight: '401', color: 'red', padding: '3% 0%' }}>
        Pharmacist
      </div>
        ...
        <div className="row d-flex align-items-center justify-content-center">
          <div className="col-md-8 col-lg-7 col-xl-6">
            ...
            <div style={{ textAlign: 'center', marginTop: '2%' }}>
              <div style={{ fontSize: '1.7rem', color: '#045E55', fontWeight: '600', padding: '0% 15%' }}>
                Welcome To Janhit Chemist
              </div>
          ...
          <div
            style={{ backgroundColor: '#F9F9F9', padding: '2%', paddingBottom: '10%', marginBottom: '3%' }}
          ...
          >
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="d-flex justify-content-between align-items-center mb-4">
                <div>
                  <Button style={{ backgroundColor: '#045E55' }} variant="primary" type="submit" disabled={loading}>
                    {loading ? 'Logging in...' : 'SHOP NOW'}
                  </Button>
                </div>
              ...
              >
                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  />
                  <path
                    d="M15.0002 27.5004C18.2289 27.5004 21.1627 26.2648 23.3808 24.2554L19.5121 20.9817C18.2151 21.9686 16.6299 22.5022 15.0002 22.5004C11.7489 22.5004 8.98832 20.4273 7.94832 17.5342L3.87207 20.6748C5.94082 24.7229 10.1421 27.5004 15.0002 27.5004Z"
                    fill="#4CAF50"
                  />
                  <path
              ...
              <Button
                style={{ backgroundColor: '#3D5898', width: '100%', border: '1px solid rgba(0,0,0,0.20)' }}
                variant="primary"
                disabled={loading}
              >
